...
const ServiceCard = ({ data }) => {
  ...
  return (
    <div
      style={{ top: data.top }}
      className="group w-[90%] sm:w-[40%] min-h-[350px] shadow-2xl border border-gray-200 bg-white flex flex-col rounded-2xl sticky overflow-hidden transition-all duration-300 hover:shadow-3xl hover:border-gray-300 hover:-translate-y-1 p-6"
    >
